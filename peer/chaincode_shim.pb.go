...
const (
	...
	ChaincodeMessage_GET_EPHEMERAL_POLICY  ChaincodeMessage_Type = 23
)
...
type GetEphemeralPolicy struct {
	Policy               *common.SignaturePolicyEnvelope `protobuf:"bytes,1,opt,name=policy,proto3" json:"policy,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                        `json:"-"`
	XXX_unrecognized     []byte                          `json:"-"`
	XXX_sizecache        int32                           `json:"-"`
}

func (m *GetEphemeralPolicy) Reset()         { *m = GetEphemeralPolicy{} }
func (m *GetEphemeralPolicy) String() string { return proto.CompactTextString(m) }
func (*GetEphemeralPolicy) ProtoMessage()    {}
func (*GetEphemeralPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_e5819fec16c96da2, []int{5}
}

func (m *GetEphemeralPolicy) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetEphemeralPolicy.Unmarshal(m, b)
}
func (m *GetEphemeralPolicy) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetEphemeralPolicy.Marshal(b, m, deterministic)
}
func (m *GetEphemeralPolicy) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetEphemeralPolicy.Merge(m, src)
}
func (m *GetEphemeralPolicy) XXX_Size() int {
	return xxx_messageInfo_GetEphemeralPolicy.Size(m)
}
func (m *GetEphemeralPolicy) XXX_DiscardUnknown() {
	xxx_messageInfo_GetEphemeralPolicy.DiscardUnknown(m)
}

var xxx_messageInfo_GetEphemeralPolicy proto.InternalMessageInfo

func (m *GetEphemeralPolicy) GetPolicy() *common.SignaturePolicyEnvelope {
	if m != nil {
		return m.Policy
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*GetEphemeralPolicy)(nil), "protos.GetEphemeralPolicy")
...
var fileDescriptor_e5819fec16c96da2 = []byte{
	...
	,
}
